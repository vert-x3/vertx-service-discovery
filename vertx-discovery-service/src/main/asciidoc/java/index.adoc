...
described by a `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`.
...
Providers and consumers must create their own `link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html[DiscoveryService]` instance. These
...
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html#getReference-io.vertx.ext.discovery.Record-[getReference]` or released with
...
Publishers and consumers must create their own `link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html[DiscoveryService]`
...
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html#getRecords-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[getRecords]`.
...
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html#getRecords-java.util.function.Function-boolean-io.vertx.core.Handler-[getRecords]`
.
...
`link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html#getClient-io.vertx.ext.discovery.DiscoveryService-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[HttpEndpoint.getClient]`
...
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html#releaseServiceObject-io.vertx.ext.discovery.DiscoveryService-java.lang.Object-[DiscoveryService.releaseServiceObject]`,
...
This address is configurable from the `link:../../apidocs/io/vertx/ext/discovery/DiscoveryOptions.html[DiscoveryOptions]`.
...
.discovery.usage` address. This address is configurable from the `link:../../apidocs/io/vertx/ext/discovery/DiscoveryOptions.html[DiscoveryOptions]`.
...
This `id` is configurable from the `link:../../apidocs/io/vertx/ext/discovery/DiscoveryOptions.html[DiscoveryOptions]`. By default it's "localhost" on
...
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryOptions.html#setUsageAddress-java.lang.String-[setUsageAddress]`.
...
register it using
`link:../../apidocs/io/vertx/ext/discovery/DiscoveryService.html#registerDiscoveryBridge-io.vertx.ext.discovery.spi.DiscoveryBridge-io.vertx.core.json.JsonObject-[registerDiscoveryBridge]`.
...
`link:../../apidocs/io/vertx/ext/discovery/spi/DiscoveryBridge.html#stop-io.vertx.core.Vertx-io.vertx.ext.discovery.DiscoveryService-io.vertx.core.Future-[stop]`
