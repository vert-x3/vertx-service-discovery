...
/**
 * Once a consumer has chosen a service, it builds a {@link io.vertx.ext.discovery.rxjava.ServiceReference} managing the binding with the chosen
 * service provider.
 * <p>
 * The reference lets the consumer:
 * * access the service (via a proxy or a client) with the {@link io.vertx.ext.discovery.rxjava.ServiceReference#get} method
 * * release the reference - so the binding between the consumer and the provider is removed
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.discovery.ServiceReference original} non RX-ified interface using Vert.x codegen.
 */

public class ServiceReference {

  final io.vertx.ext.discovery.ServiceReference delegate;

  public ServiceReference(io.vertx.ext.discovery.ServiceReference delegate) {
  ...
  public static ServiceReference newInstance(io.vertx.ext.discovery.ServiceReference arg) {
