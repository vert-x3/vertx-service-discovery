...
public class EventBusService {
  ...
  public static <T> void getProxy(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate(), filter, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, String serviceInterface, String proxyInterface, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate(), serviceInterface, proxyInterface, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, JsonObject filter, String proxyClass, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate(), filter, proxyClass, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, String itf, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate(), itf, resultHandler);
  }
