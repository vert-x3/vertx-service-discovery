 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.discovery.types.HttpEndpoint original} non RX-ified interface using Vert.x codegen.
 */

public class HttpEndpoint {

  final io.vertx.ext.discovery.types.HttpEndpoint delegate;

  public HttpEndpoint(io.vertx.ext.discovery.types.HttpEndpoint delegate) {
  ...
  public static Record createRecord(String name, String host, int port, String root, JsonObject metadata) { 
    Record ret = io.vertx.ext.discovery.types.HttpEndpoint.createRecord(name, host, port, root, metadata);
    return ret;
  }

  /**
   * Same as {@link io.vertx.ext.discovery.rxjava.types.HttpEndpoint#createRecord} but let you configure whether or not the
  ...
  public static Record createRecord(String name, boolean ssl, String host, int port, String root, JsonObject metadata) { 
    Record ret = io.vertx.ext.discovery.types.HttpEndpoint.createRecord(name, ssl, host, port, root, metadata);
    return ret;
  }

  /**
   * Same as {@link io.vertx.ext.discovery.rxjava.types.HttpEndpoint#createRecord} but without metadata.
   * @param name the service name
  ...
  public static Record createRecord(String name, String host, int port, String root) { 
    Record ret = io.vertx.ext.discovery.types.HttpEndpoint.createRecord(name, host, port, root);
    return ret;
  }

  /**
   * Same as {@link io.vertx.ext.discovery.rxjava.types.HttpEndpoint#createRecord} but without metadata, using the port 80
   * and using "/" as root.
   * @param name the name
   * @param host the host
   * @return the created record
  ...
  public static Record createRecord(String name, String host) { 
    Record ret = io.vertx.ext.discovery.types.HttpEndpoint.createRecord(name, host);
    return ret;
  }
  ...
  public static void getClient(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<HttpClient>> resultHandler) { 
    io.vertx.ext.discovery.types.HttpEndpoint.getClient((io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
  ...
  public static HttpEndpoint newInstance(io.vertx.ext.discovery.types.HttpEndpoint arg) {
