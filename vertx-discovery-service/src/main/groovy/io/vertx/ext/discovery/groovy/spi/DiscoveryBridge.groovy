...
package io.vertx.ext.discovery.groovy.spi;
...
public class DiscoveryBridge {
  private final def io.vertx.ext.discovery.spi.DiscoveryBridge delegate;
  public DiscoveryBridge(Object delegate) {
    this.delegate = (io.vertx.ext.discovery.spi.DiscoveryBridge) delegate;
  }
  ...
  public void start(Vertx vertx, DiscoveryService discovery, Map<String, Object> configuration, Future<Void> future) {
    delegate.start(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, discovery != null ? (io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate() : null, configuration != null ? new io.vertx.core.json.JsonObject(configuration) : null, future != null ? (io.vertx.core.Future<java.lang.Void>)future.getDelegate() : null);
  }
  /**
   * Stops the bridge.
   * @param vertx the vertx instance
  ...
  public void stop(Vertx vertx, DiscoveryService discovery, Future<Void> future) {
    delegate.stop(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, discovery != null ? (io.vertx.ext.discovery.DiscoveryService)discovery.getDelegate() : null, future != null ? (io.vertx.core.Future<java.lang.Void>)future.getDelegate() : null);
  }
}
