...
<p>
The service discovery has a plug-able backend using the `link:unavailable[ServiceDiscoveryBackend]` SPI. This is an implementation of the SPI based
on Consul.
<p>
...
----
compile 'io.vertx:vertx-service-discovery-backend-consul:3.5.0-SNAPSHOT'
----
<p>
