 ...
 *
 * The service discovery has a plug-able backend using the {@link io.vertx.ext.discovery.spi.DiscoveryBackend} SPI. This is an implementation of the SPI based
 * on Redis.
 *
