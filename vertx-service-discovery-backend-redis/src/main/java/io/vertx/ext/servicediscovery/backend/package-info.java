 ...
 *
 * The discovery service has a plug-able backend using the {@link io.vertx.ext.servicediscovery.spi.DiscoveryBackend} SPI. This is an implementation of the SPI based
 * on Redis.
 *
...
package io.vertx.ext.servicediscovery.backend;
