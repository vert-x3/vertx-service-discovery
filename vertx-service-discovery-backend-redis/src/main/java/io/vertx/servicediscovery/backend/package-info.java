 ...
 *
 * The discovery service has a plug-able backend using the {@link io.vertx.servicediscovery.spi.DiscoveryBackend} SPI. This is an implementation of the SPI based
 * on Redis.
 *
...
package io.vertx.servicediscovery.backend;
