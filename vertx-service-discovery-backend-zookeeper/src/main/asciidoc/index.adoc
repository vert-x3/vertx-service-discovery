...
[source,$lang]
----
{@link examples.ServiceDiscoveryBackendZookeeperExamples#configuration1(io.vertx.core.Vertx)}
----
...
[source,$lang]
----
{@link examples.ServiceDiscoveryBackendZookeeperExamples#configuration2(io.vertx.core.Vertx)}
----
