...
VertxServiceDiscovery::ServiceDiscovery.create(vertx).register_discovery_bridge(Java::IoVertxServicediscoveryDocker::DockerLinksServiceDiscoveryBridge.new(), {
})
