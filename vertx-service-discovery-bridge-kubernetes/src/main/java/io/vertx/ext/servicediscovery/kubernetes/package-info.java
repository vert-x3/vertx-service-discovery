 ...
 * Kubernetes services are mapped to {@link io.vertx.ext.servicediscovery.Record}. This bridge only
 * supports the importation of services from kubernetes in vert.x (and not the opposite).
 *
 * {@link io.vertx.ext.servicediscovery.Record} are created from Kubernetes Service. The service type is deduced from the `service.type` label. If
...
package io.vertx.ext.servicediscovery.kubernetes;
