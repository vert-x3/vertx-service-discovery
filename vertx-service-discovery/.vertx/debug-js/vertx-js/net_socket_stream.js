...
var NetSocketStream = function(j_val) {
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocketStream["exceptionHandler(io.vertx.core.Handler)"](handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocketStream["handler(io.vertx.core.Handler)"](handler == null ? null : function(jVal) {
