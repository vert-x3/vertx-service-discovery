...
* lookup for services
* bind to a selected service (it gets a `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/ServiceReference.html[ServiceReference]`) and use it
* release the service once the consumer is done with it
* listen for arrival, departure and modification of services.

Consumer would 1) lookup for service record matching their need, 2) retrieve the
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/ServiceReference.html[ServiceReference]` that give access to the service, 3) get a service object to access
...
Providers and consumers must create their own `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html[DiscoveryService]` instance. These
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/ServiceReference.html[ServiceReference]`, representing the binding between the consumer and the provider.
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html#getReference(io.vertx.ext.servicediscovery.Record)[getReference]` or released with
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/ServiceReference.html#release()[release]`, events are emitted on the event bus to track the
service usages.
...
be populated with `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/spi/DiscoveryBridge.html[DiscoveryBridge]`s.

== Creating the discovery service

Publishers and consumers must create their own `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html[DiscoveryService]`
...
[source,groovy]
----
import io.vertx.groovy.ext.servicediscovery.types.HttpEndpoint
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html#getRecords(io.vertx.core.json.JsonObject,%20io.vertx.core.Handler)[getRecords]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html#getRecords(java.util.function.Function,%20boolean,%20io.vertx.core.Handler)[getRecords]`
.

== Retrieving a service reference

Once you have chosen the `link:../dataobjects.html#Record[Record]`, you can retrieve a
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/ServiceReference.html[ServiceReference]` and then the service object:
...
* `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/HttpEndpoint.html[HttpEndpoint]` - for REST API, the service object is a
...
* `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/EventBusService.html[EventBusService]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/MessageSource.html[MessageSource]` - for message source (publisher), the service object is a
`link:../../groovydoc/io/vertx/groovy/core/eventbus/MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/JDBCDataSource.html[JDBCDataSource]` - for JDBC data sources, the service object is a
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/HttpEndpoint.html#createRecord(java.lang.String,%20java.lang.String,%20int,%20java.lang.String,%20io.vertx.core.json.JsonObject)[HttpEndpoint.createRecord]`.

The next snippet illustrates hot to create `link:../dataobjects.html#Record[Record]` from
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/HttpEndpoint.html[HttpEndpoint]`:
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/HttpEndpoint.html#getClient(io.vertx.ext.servicediscovery.DiscoveryService,%20io.vertx.core.json.JsonObject,%20io.vertx.core.Handler)[HttpEndpoint.getClient]`
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html#releaseServiceObject(io.vertx.ext.servicediscovery.DiscoveryService,%20java.lang.Object)[DiscoveryService.releaseServiceObject]`,
...
methods from `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/EventBusService.html[EventBusService]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/EventBusService.html[EventBusService]` interface that combines the two operations in one call.
...
1. create a record, using `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/MessageSource.html[MessageSource]`
2. publish the record

[source, groovy]
----
import io.vertx.groovy.ext.servicediscovery.types.MessageSource
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/MessageSource.html[MessageSource]` class to retrieve the service is one call.
...
When, using `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/MessageSource.html[MessageSource]`, it becomes:
...
1. create a record, using `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/types/JDBCDataSource.html[JDBCDataSource]`
2. publish the record

[source, groovy]
----
import io.vertx.groovy.ext.servicediscovery.types.JDBCDataSource
...
You can provide your own bridge by implementing the `link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/spi/DiscoveryBridge.html[DiscoveryBridge]` interface and
register it using
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/DiscoveryService.html#registerDiscoveryBridge(io.vertx.ext.servicediscovery.spi.DiscoveryBridge,%20io.vertx.core.json.JsonObject)[registerDiscoveryBridge]`.
...
`link:../../groovydoc/io/vertx/groovy/ext/servicediscovery/spi/DiscoveryBridge.html#stop(io.vertx.core.Vertx,%20io.vertx.ext.servicediscovery.DiscoveryService,%20io.vertx.core.Future)[stop]`
