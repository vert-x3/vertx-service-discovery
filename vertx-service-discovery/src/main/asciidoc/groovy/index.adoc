...
`link:../../groovydoc/io/vertx/groovy/servicediscovery/spi/DiscoveryBridge.html#stop(io.vertx.core.Vertx,%20io.vertx.servicediscovery.DiscoveryService,%20io.vertx.core.Future)[stop]`
