...
`link:../../groovydoc/io/vertx/groovy/servicediscovery/spi/ServiceDiscoveryBridge.html#stop(io.vertx.core.Vertx,%20io.vertx.servicediscovery.ServiceDiscovery,%20io.vertx.core.Future)[stop]`
