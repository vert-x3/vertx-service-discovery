...
Since Vert.x 3.4.0, another client has been provided. This higher-level client, named `link:../../apidocs/io/vertx/webclient/WebClient.html[WebClient]`
tends to be easier to use. You can retrieve a `link:../../apidocs/io/vertx/webclient/WebClient.html[WebClient]` instances using:
