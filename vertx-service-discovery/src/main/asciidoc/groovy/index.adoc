...
* `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/HttpEndpointType.html[HttpEndpointType]` - for REST API's, the service object is a
...
* `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/MessageSourceType.html[MessageSourceType]` - for message sources (publisher), the service object is a
`link:../../groovydoc/io/vertx/groovy/core/eventbus/MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/JDBCDataSourceType.html[JDBCDataSourceType]` - for JDBC data sources, the service object is a
...
`link:../../groovydoc/io/vertx/groovy/servicediscovery/types/HttpEndpointType.html[HttpEndpointType]`:
...
methods from `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]`.
...
`link:../../groovydoc/io/vertx/groovy/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]` interface that combines the two operations in one call.
...
1. create a record, using `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/MessageSourceType.html[MessageSourceType]`
...
`link:../../groovydoc/io/vertx/groovy/servicediscovery/types/MessageSourceType.html[MessageSourceType]` class to retrieve the service is one call.
...
When, using `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/MessageSourceType.html[MessageSourceType]`, it becomes:
...
1. create a record, using `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/JDBCDataSourceType.html[JDBCDataSourceType]`
2. publish the record
...
1. create a record, using `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/RedisDataSourceType.html[RedisDataSourceType]`
2. publish the record
...
You can also use the `link:../../groovydoc/io/vertx/groovy/servicediscovery/types/RedisDataSourceType.html[RedisDataSourceType]` class to the lookup and retrieval in one call:
