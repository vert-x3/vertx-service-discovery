...
If the bridge starts method is blocking, it must use an {@link io.vertx.core.Vertx#executeBlocking(io.vertx.core.Handler, boolean, io.vertx.core.Handler)} construct, and complete the given future object.
