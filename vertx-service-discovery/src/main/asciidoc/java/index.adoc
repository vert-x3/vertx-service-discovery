...
be populated with `link:../../apidocs/io/vertx/servicediscovery/spi/ServiceDiscoveryBridge.html[ServiceDiscoveryBridge]`s.
...
You can provide your own bridge by implementing the `link:../../apidocs/io/vertx/servicediscovery/spi/ServiceDiscoveryBridge.html[ServiceDiscoveryBridge]` interface and
register it using
`link:../../apidocs/io/vertx/servicediscovery/ServiceDiscovery.html#registerDiscoveryBridge-io.vertx.servicediscovery.spi.ServiceDiscoveryBridge-io.vertx.core.json.JsonObject-[registerDiscoveryBridge]`.
...
`link:../../apidocs/io/vertx/servicediscovery/spi/ServiceDiscoveryBridge.html#stop-io.vertx.core.Vertx-io.vertx.servicediscovery.spi.ServicePublisher-io.vertx.core.Future-[stop]`
