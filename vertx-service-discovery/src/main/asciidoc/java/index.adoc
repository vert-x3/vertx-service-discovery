...
* `link:../../apidocs/io/vertx/servicediscovery/types/HttpEndpointType.html[HttpEndpointType]` - for REST API's, the service object is a
`link:../../apidocs/io/vertx/core/http/HttpClient.html[HttpClient]` configured on the host and port (the location is the url).
* `link:../../apidocs/io/vertx/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../apidocs/io/vertx/servicediscovery/types/MessageSourceType.html[MessageSourceType]` - for message sources (publisher), the service object is a
`link:../../apidocs/io/vertx/core/eventbus/MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../apidocs/io/vertx/servicediscovery/types/JDBCDataSourceType.html[JDBCDataSourceType]` - for JDBC data sources, the service object is a
...
is the type of service object you retrieve and so on. Check `link:../../apidocs/io/vertx/servicediscovery/types/HttpEndpointType.html[HttpEndpointType]` or
`link:../../apidocs/io/vertx/servicediscovery/types/MessageSourceType.html[MessageSourceType]` for example
...
`link:../../apidocs/io/vertx/servicediscovery/types/HttpEndpointType.html[HttpEndpointType]`:
...
methods from `link:../../apidocs/io/vertx/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]`.
...
`link:../../apidocs/io/vertx/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]` interface that combines the two operations in one call.
...
With the `link:../../apidocs/io/vertx/servicediscovery/types/EventBusServiceType.html[EventBusServiceType]` class, you can get the proxy as follows:
[source, java]
----
...
1. create a record, using `link:../../apidocs/io/vertx/servicediscovery/types/MessageSourceType.html[MessageSourceType]`
...
`link:../../apidocs/io/vertx/servicediscovery/types/MessageSourceType.html[MessageSourceType]` class to retrieve the service is one call.
...
When, using `link:../../apidocs/io/vertx/servicediscovery/types/MessageSourceType.html[MessageSourceType]`, it becomes:
...
1. create a record, using `link:../../apidocs/io/vertx/servicediscovery/types/JDBCDataSourceType.html[JDBCDataSourceType]`
2. publish the record
...
1. create a record, using `link:../../apidocs/io/vertx/servicediscovery/types/RedisDataSourceType.html[RedisDataSourceType]`
2. publish the record
...
You can also use the `link:../../apidocs/io/vertx/servicediscovery/types/RedisDataSourceType.html[RedisDataSourceType]` class to the lookup and retrieval in one call:
