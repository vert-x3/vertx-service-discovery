...
`link:../../apidocs/io/vertx/servicediscovery/spi/DiscoveryBridge.html#stop-io.vertx.core.Vertx-io.vertx.servicediscovery.DiscoveryService-io.vertx.core.Future-[stop]`
