...
register it using
`link:../../apidocs/io/vertx/servicediscovery/ServiceDiscovery.html#registerDiscoveryBridge-io.vertx.servicediscovery.spi.ServiceImporter-io.vertx.core.json.JsonObject-[registerDiscoveryBridge]`.
