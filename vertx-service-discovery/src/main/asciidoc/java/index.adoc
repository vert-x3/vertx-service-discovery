...
`link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`.
...
* lookup for services
* bind to a selected service (it gets a `link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html[ServiceReference]`) and use it
* release the service once the consumer is done with it
* listen for arrival, departure and modification of services.

Consumer would 1) lookup for service record matching their need, 2) retrieve the
`link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html[ServiceReference]` that give access to the service, 3) get a service object to access
...
`link:../../apidocs/io/vertx/ext/discovery/Record.html[records]`.

Providers and consumers must create their own `link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html[ServiceDiscovery]` instance. These
...
A service `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]` is an object that describes a service published by a service
...
`link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`. From these records, a consumer can retrieve a
`link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html[ServiceReference]`, representing the binding between the consumer and the provider.
...
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html#getReference-io.vertx.ext.discovery.Record-[getReference]` or released with
`link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html#release--[release]`, events are emitted on the event bus to track the
service usages.
...
`link:../../apidocs/io/vertx/ext/discovery/spi/DiscoveryBackend.html[DiscoveryBackend]` SPI.

Notice that the discovery does not require vert.x clustering. In single-node mode, the map is a local map. It can
be populated with `link:../../apidocs/io/vertx/ext/discovery/spi/DiscoveryBridge.html[DiscoveryBridge]`s.

== Creating a service discovery instance

Publishers and consumers must create their own `link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html[ServiceDiscovery]`
...
To create records, you can either use the `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]` class, or use convenient methods
...
1. A function taking a `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]` as parameter and returning a boolean
...
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html#getRecords-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[getRecords]`.
...
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html#getRecords-java.util.function.Function-boolean-io.vertx.core.Handler-[getRecords]`
.

== Retrieving a service reference

Once you have chosen the `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`, you can retrieve a
`link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html[ServiceReference]` and then the service object:
...
* `link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html[HttpEndpoint]` - for REST API, the service object is a
`link:../../apidocs/io/vertx/core/http/HttpClient.html[HttpClient]` configured on the host and port (the location is the url).
* `link:../../apidocs/io/vertx/ext/discovery/types/EventBusService.html[EventBusService]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../apidocs/io/vertx/ext/discovery/types/MessageSource.html[MessageSource]` - for message source (publisher), the service object is a
`link:../../apidocs/io/vertx/core/eventbus/MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../apidocs/io/vertx/ext/discovery/types/JDBCDataSource.html[JDBCDataSource]` - for JDBC data sources, the service object is a
...
Some records may have no type (`link:../../apidocs/io/vertx/ext/discovery/spi/ServiceType.html#UNKNOWN[ServiceType.UNKNOWN]`). It is not possible to
retrieve a reference for these records, but you can build the connection details from the `location` and
`metadata` of the `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`.

Using these services does not fire service usage events.

=== Implementing your own service type

You can create your own service type by implementing the `link:../../apidocs/io/vertx/ext/discovery/spi/ServiceType.html[ServiceType]` SPI:

1. (optional) Create a public interface extending `link:../../apidocs/io/vertx/ext/discovery/spi/ServiceType.html[ServiceType]`. This interface is
only used to provide helper methods to ease the usage of your type such as `createRecord` methods, `getX` where `X`
is the type of service object you retrieve and so on. Check `link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html[HttpEndpoint]` or
`link:../../apidocs/io/vertx/ext/discovery/types/MessageSource.html[MessageSource]` for examples
2. Create a class implementing `link:../../apidocs/io/vertx/ext/discovery/spi/ServiceType.html[ServiceType]` or the interface you created in the
step 1. The type has a `name`, and a method to create the `link:../../apidocs/io/vertx/ext/discovery/ServiceReference.html[ServiceReference]` for this
type. The name must match the `type` field of the `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]` associated with your type.
...
To publish a HTTP endpoint, you need a `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`. You can create the record using
`link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html#createRecord-java.lang.String-java.lang.String-int-java.lang.String-io.vertx.core.json.JsonObject-[HttpEndpoint.createRecord]`.

The next snippet illustrates hot to create `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]` from
`link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html[HttpEndpoint]`:
...
`link:../../apidocs/io/vertx/ext/discovery/types/HttpEndpoint.html#getClient-io.vertx.ext.discovery.ServiceDiscovery-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[HttpEndpoint.getClient]`
...
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html#releaseServiceObject-io.vertx.ext.discovery.ServiceDiscovery-java.lang.Object-[ServiceDiscovery.releaseServiceObject]`,
...
methods from `link:../../apidocs/io/vertx/ext/discovery/types/EventBusService.html[EventBusService]`.
...
To publish an event bus service, you need to create a `link:../../apidocs/io/vertx/ext/discovery/Record.html[Record]`:
...
`link:../../apidocs/io/vertx/ext/discovery/types/EventBusService.html[EventBusService]` interface that combine the two operations in one call.
...
With the `link:../../apidocs/io/vertx/ext/discovery/types/EventBusService.html[EventBusService]` class, you can get the proxy as follows:
[source, java]
----
...
1. create a record, using `link:../../apidocs/io/vertx/ext/discovery/types/MessageSource.html[MessageSource]`
...
`link:../../apidocs/io/vertx/ext/discovery/types/MessageSource.html[MessageSource]` class to retrieve the service is one call.
...
When, using `link:../../apidocs/io/vertx/ext/discovery/types/MessageSource.html[MessageSource]`, it becomes:
...
1. create a record, using `link:../../apidocs/io/vertx/ext/discovery/types/JDBCDataSource.html[JDBCDataSource]`
2. publish the record
...
This address is configurable from the `link:../../apidocs/io/vertx/ext/discovery/ServiceDiscoveryOptions.html[ServiceDiscoveryOptions]`.
...
.discovery.usage` address. This address is configurable from the `link:../../apidocs/io/vertx/ext/discovery/ServiceDiscoveryOptions.html[ServiceDiscoveryOptions]`.
...
This `id` is configurable from the `link:../../apidocs/io/vertx/ext/discovery/ServiceDiscoveryOptions.html[ServiceDiscoveryOptions]`. By default it's "localhost" on
...
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscoveryOptions.html#setUsageAddress-java.lang.String-[setUsageAddress]`.
...
You can provide your own bridge by implementing the `link:../../apidocs/io/vertx/ext/discovery/spi/DiscoveryBridge.html[DiscoveryBridge]` interface and
register it using
`link:../../apidocs/io/vertx/ext/discovery/ServiceDiscovery.html#registerDiscoveryBridge-io.vertx.ext.discovery.spi.DiscoveryBridge-io.vertx.core.json.JsonObject-[registerDiscoveryBridge]`.
...
`link:../../apidocs/io/vertx/ext/discovery/spi/DiscoveryBridge.html#stop-io.vertx.core.Vertx-io.vertx.ext.discovery.ServiceDiscovery-io.vertx.core.Future-[stop]`
