...
`link:../../apidocs/io/vertx/servicediscovery/spi/ServiceDiscoveryBridge.html#stop-io.vertx.core.Vertx-io.vertx.servicediscovery.ServiceDiscovery-io.vertx.core.Future-[stop]`
