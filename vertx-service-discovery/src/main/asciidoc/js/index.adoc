...
be populated with `link:../../jsdoc/module-vertx-service-discovery-js_service_importer-ServiceImporter.html[ServiceImporter]`s. Since 3.5.0, you can use a local
