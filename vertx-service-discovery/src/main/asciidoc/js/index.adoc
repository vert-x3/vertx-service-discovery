...
* `link:../../jsdoc/module-vertx-service-discovery-js_http_endpoint_type-HttpEndpointType.html[HttpEndpointType]` - for REST API's, the service object is a
...
* `link:../../jsdoc/module-vertx-service-discovery-js_event_bus_service_type-EventBusServiceType.html[EventBusServiceType]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../jsdoc/module-vertx-service-discovery-js_message_source_type-MessageSourceType.html[MessageSourceType]` - for message sources (publisher), the service object is a
`link:../../jsdoc/module-vertx-js_message_consumer-MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../jsdoc/module-vertx-service-discovery-js_jdbc_data_source_type-JDBCDataSourceType.html[JDBCDataSourceType]` - for JDBC data sources, the service object is a
...
`link:../../jsdoc/module-vertx-service-discovery-js_http_endpoint_type-HttpEndpointType.html[HttpEndpointType]`:
...
methods from `link:../../jsdoc/module-vertx-service-discovery-js_event_bus_service_type-EventBusServiceType.html[EventBusServiceType]`.
...
1. create a record, using `link:../../jsdoc/module-vertx-service-discovery-js_message_source_type-MessageSourceType.html[MessageSourceType]`
...
`link:../../jsdoc/module-vertx-service-discovery-js_message_source_type-MessageSourceType.html[MessageSourceType]` class to retrieve the service is one call.
...
When, using `link:../../jsdoc/module-vertx-service-discovery-js_message_source_type-MessageSourceType.html[MessageSourceType]`, it becomes:
...
1. create a record, using `link:../../jsdoc/module-vertx-service-discovery-js_jdbc_data_source_type-JDBCDataSourceType.html[JDBCDataSourceType]`
2. publish the record
...
1. create a record, using `link:../../jsdoc/module-vertx-service-discovery-js_redis_data_source_type-RedisDataSourceType.html[RedisDataSourceType]`
2. publish the record
...
You can also use the `link:../../jsdoc/module-vertx-service-discovery-js_redis_data_source_type-RedisDataSourceType.html[RedisDataSourceType]` class to the lookup and retrieval in one call:
