...
discovery = ServiceDiscovery.create(vertx, io.vertx.servicediscovery.ServiceDiscoveryOptions(
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.HttpEndpoint
...
discovery.getRecords({ r ->
  "some-value" == r.metadata.get<Any?>("some-label")
}, { ar ->
  if (ar.succeeded()) {
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.core.eventbus.MessageConsumer
import io.vertx.kotlin.core.http.HttpClient
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.ext.jdbc.JDBCClient
...
HttpEndpoint.getClient(discovery, json {
  obj("name" to "some-http-service")
}, { ar ->
  if (ar.succeeded()) {
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.ext.web.client.WebClient
...
HttpEndpoint.getWebClient(discovery, json {
  obj("name" to "some-http-service")
}, { ar ->
  if (ar.succeeded()) {
    var client = ar.result()
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.EventBusService

var record = EventBusService.createRecord("some-eventbus-service", "address", "examples.MyService", json {
  obj("some-metadata" to "some value")
})
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.MessageSource
...
MessageSource.getConsumer(discovery, json {
  obj("name" to "some-message-source-service")
}, { ar ->
  if (ar.succeeded()) {
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.JDBCDataSource

var record = JDBCDataSource.createRecord("some-data-source-service", json {
...
JDBCDataSource.getJDBCClient(discovery, json {
  obj("name" to "some-data-source-service")
}, json {
  obj(
    "username" to "clement",
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.RedisDataSource

var record = RedisDataSource.createRecord("some-redis-data-source-service", json {
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.redis.RedisClient
...
RedisDataSource.getRedisClient(discovery, json {
  obj("name" to "some-redis-data-source-service")
}, { ar ->
  if (ar.succeeded()) {
    var client = ar.result()
...
----
import io.vertx.kotlin.common.json.*
import io.vertx.kotlin.servicediscovery.types.MongoDataSource

var record = MongoDataSource.createRecord("some-data-source-service", json {
...
MongoDataSource.getMongoClient(discovery, json {
  obj("name" to "some-data-source-service")
}, json {
  obj(
    "username" to "clement",
