...
be populated with `link:../../yardoc/VertxServiceDiscovery/ServiceDiscoveryBridge.html[ServiceDiscoveryBridge]`s.
...
You can provide your own bridge by implementing the `link:../../yardoc/VertxServiceDiscovery/ServiceDiscoveryBridge.html[ServiceDiscoveryBridge]` interface and
register it using
`link:../../yardoc/VertxServiceDiscovery/ServiceDiscovery.html#register_discovery_bridge-instance_method[registerDiscoveryBridge]`.
...
`link:../../yardoc/VertxServiceDiscovery/ServiceDiscoveryBridge.html#stop-instance_method[stop]`
