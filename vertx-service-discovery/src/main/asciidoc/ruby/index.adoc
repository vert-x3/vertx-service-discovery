...
* `link:../../yardoc/VertxServiceDiscovery/HttpEndpointType.html[HttpEndpointType]` - for REST API's, the service object is a
`link:../../yardoc/Vertx/HttpClient.html[HttpClient]` configured on the host and port (the location is the url).
* `link:../../yardoc/VertxServiceDiscovery/EventBusServiceType.html[EventBusServiceType]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:../../yardoc/VertxServiceDiscovery/MessageSourceType.html[MessageSourceType]` - for message sources (publisher), the service object is a
`link:../../yardoc/Vertx/MessageConsumer.html[MessageConsumer]` (the location is the address).
* `link:../../yardoc/VertxServiceDiscovery/JDBCDataSourceType.html[JDBCDataSourceType]` - for JDBC data sources, the service object is a
...
`link:../../yardoc/VertxServiceDiscovery/HttpEndpointType.html[HttpEndpointType]`:
...
methods from `link:../../yardoc/VertxServiceDiscovery/EventBusServiceType.html[EventBusServiceType]`.
...
1. create a record, using `link:../../yardoc/VertxServiceDiscovery/MessageSourceType.html[MessageSourceType]`
...
`link:../../yardoc/VertxServiceDiscovery/MessageSourceType.html[MessageSourceType]` class to retrieve the service is one call.
...
When, using `link:../../yardoc/VertxServiceDiscovery/MessageSourceType.html[MessageSourceType]`, it becomes:
...
1. create a record, using `link:../../yardoc/VertxServiceDiscovery/JDBCDataSourceType.html[JDBCDataSourceType]`
2. publish the record
...
1. create a record, using `link:../../yardoc/VertxServiceDiscovery/RedisDataSourceType.html[RedisDataSourceType]`
2. publish the record
...
You can also use the `link:../../yardoc/VertxServiceDiscovery/RedisDataSourceType.html[RedisDataSourceType]` class to the lookup and retrieval in one call:
