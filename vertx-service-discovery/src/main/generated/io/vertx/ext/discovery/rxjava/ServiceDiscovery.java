 ...
 * <p>
 * Providers and consumers must create their own {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery} instance. These instances are collaborating
 * in background (distributed structure) to keep the set of services in sync.
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.discovery.ServiceDiscovery original} non RX-ified interface using Vert.x codegen.
 */

public class ServiceDiscovery {

  final io.vertx.ext.discovery.ServiceDiscovery delegate;

  public ServiceDiscovery(io.vertx.ext.discovery.ServiceDiscovery delegate) {
  ...
  /**
   * Creates an instance of {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery}.
  ...
  public static ServiceDiscovery create(Vertx vertx, ServiceDiscoveryOptions options) { 
    ServiceDiscovery ret = ServiceDiscovery.newInstance(io.vertx.ext.discovery.ServiceDiscovery.create((io.vertx.core.Vertx)vertx.getDelegate(), options));
    return ret;
  }

  /**
   * Creates a new instance of {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery} using the default configuration.
   * @param vertx the vert.x instance
   * @return the created instance
   */
  public static ServiceDiscovery create(Vertx vertx) { 
    ServiceDiscovery ret = ServiceDiscovery.newInstance(io.vertx.ext.discovery.ServiceDiscovery.create((io.vertx.core.Vertx)vertx.getDelegate()));
    return ret;
  }
   ...
   * @return the current {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery}
   */
  public ServiceDiscovery registerDiscoveryBridge(DiscoveryBridge bridge, JsonObject configuration) { 
    ServiceDiscovery ret = ServiceDiscovery.newInstance(delegate.registerDiscoveryBridge((io.vertx.ext.discovery.spi.DiscoveryBridge)bridge.getDelegate(), configuration));
    return ret;
  }
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery#getRecord}, this method may accept records with a <code>OUT OF SERVICE</code>
  ...
  /**
   * Lookups for a set of records. Unlike {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery#getRecord}, this method returns all matching
   * records.
   * @param filter the filter - see {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery#getRecord}
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.ext.discovery.rxjava.ServiceDiscovery#getRecords}, this method may accept records with a <code>OUT OF SERVICE</code>
   * status, if the <code>includeOutOfService</code> parameter is set to <code>true</code>.
   * @param filter the filter, must not be <code>null</code>. To return all records, use a function accepting all records
   * @param includeOutOfService whether or not the filter accepts <code>OUT OF SERVICE</code> records
   * @param resultHandler handler called when the lookup has been completed. When there are no matching record, the operation succeed, but the async result has an empty list as result.
  ...
  public static void releaseServiceObject(ServiceDiscovery discovery, Object svcObject) { 
    io.vertx.ext.discovery.ServiceDiscovery.releaseServiceObject((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), svcObject);
  }


  public static ServiceDiscovery newInstance(io.vertx.ext.discovery.ServiceDiscovery arg) {
