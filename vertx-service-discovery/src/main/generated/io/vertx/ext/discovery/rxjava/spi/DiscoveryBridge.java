...
public class DiscoveryBridge {
  ...
  public void start(Vertx vertx, ServiceDiscovery discovery, JsonObject configuration, Future<Void> future) { 
    delegate.start((io.vertx.core.Vertx)vertx.getDelegate(), (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), configuration, (io.vertx.core.Future<java.lang.Void>)future.getDelegate());
  }
  ...
  public void stop(Vertx vertx, ServiceDiscovery discovery, Future<Void> future) { 
    delegate.stop((io.vertx.core.Vertx)vertx.getDelegate(), (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), (io.vertx.core.Future<java.lang.Void>)future.getDelegate());
  }
