...
import io.vertx.ext.discovery.rxjava.ServiceDiscovery;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.discovery.types.EventBusService original} non RX-ified interface using Vert.x codegen.
 */

public class EventBusService {

  final io.vertx.ext.discovery.types.EventBusService delegate;

  public EventBusService(io.vertx.ext.discovery.types.EventBusService delegate) {
  ...
  public static Record createRecord(String name, String address, String itf, JsonObject metadata) { 
    Record ret = io.vertx.ext.discovery.types.EventBusService.createRecord(name, address, itf, metadata);
    return ret;
  }
   ...
   */
  public static <T> void getProxy(ServiceDiscovery discovery, JsonObject filter, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), filter, resultHandler);
  }
   ...
   * @return 
   */
  public static <T> Observable<T> getProxyObservable(ServiceDiscovery discovery, JsonObject filter) { 
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String serviceInterface, String proxyInterface, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), serviceInterface, proxyInterface, resultHandler);
  }
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, JsonObject filter, String proxyClass, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), filter, proxyClass, resultHandler);
  }
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String itf, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.discovery.types.EventBusService.getProxy((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), itf, resultHandler);
  }
   ...
   * @return 
   */
  public static <T> Observable<T> getProxyObservable(ServiceDiscovery discovery, String itf) { 
    io.vertx.rx.java.ObservableFuture<T> resultHandler = io.vertx.rx.java.RxHelper.observableFuture();
  ...
  public static EventBusService newInstance(io.vertx.ext.discovery.types.EventBusService arg) {
