...
public class HttpEndpoint {
  ...
  public static void getClient(ServiceDiscovery discovery, JsonObject filter, Handler<AsyncResult<HttpClient>> resultHandler) { 
    io.vertx.ext.discovery.types.HttpEndpoint.getClient((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
