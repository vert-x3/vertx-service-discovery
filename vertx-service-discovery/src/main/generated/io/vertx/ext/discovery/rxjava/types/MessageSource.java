...
public class MessageSource {
  ...
  public static <T> void getConsumer(ServiceDiscovery discovery, JsonObject filter, Handler<AsyncResult<MessageConsumer<T>>> resultHandler) { 
    io.vertx.ext.discovery.types.MessageSource.getConsumer((io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.core.eventbus.MessageConsumer<T>>>() {
