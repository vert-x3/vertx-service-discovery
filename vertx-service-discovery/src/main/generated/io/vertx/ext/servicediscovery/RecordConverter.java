...
/**
 * Converter for {@link io.vertx.ext.servicediscovery.Record}.
 *
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.servicediscovery.Record} original class using Vert.x codegen.
 */
public class RecordConverter {
  ...
  public static void fromJson(JsonObject json, Record obj) {
    ...
    if (json.getValue("status") instanceof String) {
      obj.setStatus(io.vertx.ext.servicediscovery.Status.valueOf((String)json.getValue("status")));
    }
