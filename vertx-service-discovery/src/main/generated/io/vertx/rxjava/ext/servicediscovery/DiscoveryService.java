...
import io.vertx.rxjava.ext.servicediscovery.spi.DiscoveryBridge;
 ...
 * <p>
 * * lookup for services
 * * bind to a selected service (it gets a {@link io.vertx.rxjava.ext.servicediscovery.ServiceReference}) and use it
 * * release the service once the consumer is done with it
 * * listen for arrival, departure and modification of services.
 * <p>
 * Consumer would 1) lookup for service record matching their need, 2) retrieve the {@link io.vertx.rxjava.ext.servicediscovery.ServiceReference} that give access
 * to the service, 3) get a service object to access the service, 4) release the service object once done.
 * <p>
 * A state above, the central piece of information shared by the providers and consumers are {@link io.vertx.ext.servicediscovery.Record}.
 * <p>
 * Providers and consumers must create their own {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService} instance. These instances are collaborating
 * in background (distributed structure) to keep the set of services in sync.
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.servicediscovery.DiscoveryService original} non RX-ified interface using Vert.x codegen.
 */

public class DiscoveryService {

  final io.vertx.ext.servicediscovery.DiscoveryService delegate;

  public DiscoveryService(io.vertx.ext.servicediscovery.DiscoveryService delegate) {
  ...
  /**
   * Creates an instance of {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService}.
  ...
  public static DiscoveryService create(Vertx vertx, DiscoveryOptions options) { 
    DiscoveryService ret = DiscoveryService.newInstance(io.vertx.ext.servicediscovery.DiscoveryService.create((io.vertx.core.Vertx)vertx.getDelegate(), options));
    return ret;
  }

  /**
   * Creates a new instance of {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService} using the default configuration.
   * @param vertx the vert.x instance
   * @return the created instance
   */
  public static DiscoveryService create(Vertx vertx) { 
    DiscoveryService ret = DiscoveryService.newInstance(io.vertx.ext.servicediscovery.DiscoveryService.create((io.vertx.core.Vertx)vertx.getDelegate()));
    return ret;
  }
  ...
  public boolean release(ServiceReference reference) { 
    boolean ret = delegate.release((io.vertx.ext.servicediscovery.ServiceReference)reference.getDelegate());
    return ret;
  }
   ...
   * @return the current {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService}
   */
  public DiscoveryService registerDiscoveryBridge(DiscoveryBridge bridge, JsonObject configuration) { 
    DiscoveryService ret = DiscoveryService.newInstance(delegate.registerDiscoveryBridge((io.vertx.ext.servicediscovery.spi.DiscoveryBridge)bridge.getDelegate(), configuration));
    return ret;
  }
   ...
   * Lookups for a single record.
   * <p>
   * The filter is a  taking a {@link io.vertx.ext.servicediscovery.Record} as argument and returning a boolean. You should see it
  ...
  public void getRecord(Function<Record,Boolean> filter, Handler<AsyncResult<Record>> resultHandler) { 
    delegate.getRecord(new java.util.function.Function<io.vertx.ext.servicediscovery.Record,java.lang.Boolean>() {
      public java.lang.Boolean apply(io.vertx.ext.servicediscovery.Record arg) {
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService#getRecord}, this method may accept records with a <code>OUT OF SERVICE</code>
  ...
  /**
   * Lookups for a set of records. Unlike {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService#getRecord}, this method returns all matching
   * records.
   * @param filter the filter - see {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService#getRecord}
  ...
  public void getRecords(Function<Record,Boolean> filter, Handler<AsyncResult<List<Record>>> resultHandler) { 
    delegate.getRecords(new java.util.function.Function<io.vertx.ext.servicediscovery.Record,java.lang.Boolean>() {
      public java.lang.Boolean apply(io.vertx.ext.servicediscovery.Record arg) {
        Boolean ret = filter.apply(arg);
        return ret;
      }
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.rxjava.ext.servicediscovery.DiscoveryService#getRecords}, this method may accept records with a <code>OUT OF SERVICE</code>
   * status, if the <code>includeOutOfService</code> parameter is set to <code>true</code>.
   * @param filter the filter, must not be <code>null</code>. To return all records, use a function accepting all records
   * @param includeOutOfService whether or not the filter accepts <code>OUT OF SERVICE</code> records
   * @param resultHandler handler called when the lookup has been completed. When there are no matching record, the operation succeed, but the async result has an empty list as result.
  ...
  public static void releaseServiceObject(DiscoveryService discovery, Object svcObject) { 
    io.vertx.ext.servicediscovery.DiscoveryService.releaseServiceObject((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), svcObject);
  }


  public static DiscoveryService newInstance(io.vertx.ext.servicediscovery.DiscoveryService arg) {
