 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.servicediscovery.types.EventBusService original} non RX-ified interface using Vert.x codegen.
 */

public class EventBusService {

  final io.vertx.ext.servicediscovery.types.EventBusService delegate;

  public EventBusService(io.vertx.ext.servicediscovery.types.EventBusService delegate) {
  ...
  public static Record createRecord(String name, String address, String itf, JsonObject metadata) { 
    Record ret = io.vertx.ext.servicediscovery.types.EventBusService.createRecord(name, address, itf, metadata);
    return ret;
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.EventBusService.getProxy((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, String serviceInterface, String proxyInterface, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.EventBusService.getProxy((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), serviceInterface, proxyInterface, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, JsonObject filter, String proxyClass, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.EventBusService.getProxy((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, proxyClass, resultHandler);
  }
  ...
  public static <T> void getProxy(DiscoveryService discovery, String itf, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.EventBusService.getProxy((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), itf, resultHandler);
  }
  ...
  public static EventBusService newInstance(io.vertx.ext.servicediscovery.types.EventBusService arg) {
