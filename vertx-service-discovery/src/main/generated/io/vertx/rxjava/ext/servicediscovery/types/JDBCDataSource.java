...
import io.vertx.ext.servicediscovery.types.DataSource;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.ext.servicediscovery.types.JDBCDataSource original} non RX-ified interface using Vert.x codegen.
 */

public class JDBCDataSource {

  final io.vertx.ext.servicediscovery.types.JDBCDataSource delegate;

  public JDBCDataSource(io.vertx.ext.servicediscovery.types.JDBCDataSource delegate) {
  ...
  public static Record createRecord(String name, JsonObject location, JsonObject metadata) { 
    Record ret = io.vertx.ext.servicediscovery.types.JDBCDataSource.createRecord(name, location, metadata);
    return ret;
  }
  ...
  public static void getJDBCClient(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<JDBCClient>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.JDBCDataSource.getJDBCClient((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.ext.jdbc.JDBCClient>>() {
  ...
  public static void getJDBCClient(DiscoveryService discovery, JsonObject filter, JsonObject consumerConfiguration, Handler<AsyncResult<JDBCClient>> resultHandler) { 
    io.vertx.ext.servicediscovery.types.JDBCDataSource.getJDBCClient((io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, consumerConfiguration, new Handler<AsyncResult<io.vertx.ext.jdbc.JDBCClient>>() {
      public void handle(AsyncResult<io.vertx.ext.jdbc.JDBCClient> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture(JDBCClient.newInstance(ar.result())));
        } else {
  ...
  public static JDBCDataSource newInstance(io.vertx.ext.servicediscovery.types.JDBCDataSource arg) {
