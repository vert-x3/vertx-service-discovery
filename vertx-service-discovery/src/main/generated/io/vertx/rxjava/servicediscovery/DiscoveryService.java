...
import io.vertx.rxjava.servicediscovery.spi.DiscoveryBridge;
 ...
 * <p>
 * Providers and consumers must create their own {@link io.vertx.rxjava.servicediscovery.DiscoveryService} instance. These instances are collaborating
 * in background (distributed structure) to keep the set of services in sync.
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link io.vertx.servicediscovery.DiscoveryService original} non RX-ified interface using Vert.x codegen.
 */

public class DiscoveryService {

  final io.vertx.servicediscovery.DiscoveryService delegate;

  public DiscoveryService(io.vertx.servicediscovery.DiscoveryService delegate) {
  ...
  /**
   * Creates an instance of {@link io.vertx.rxjava.servicediscovery.DiscoveryService}.
  ...
  public static DiscoveryService create(Vertx vertx, DiscoveryOptions options) { 
    DiscoveryService ret = DiscoveryService.newInstance(io.vertx.servicediscovery.DiscoveryService.create((io.vertx.core.Vertx)vertx.getDelegate(), options));
    return ret;
  }

  /**
   * Creates a new instance of {@link io.vertx.rxjava.servicediscovery.DiscoveryService} using the default configuration.
   * @param vertx the vert.x instance
   * @return the created instance
   */
  public static DiscoveryService create(Vertx vertx) { 
    DiscoveryService ret = DiscoveryService.newInstance(io.vertx.servicediscovery.DiscoveryService.create((io.vertx.core.Vertx)vertx.getDelegate()));
    return ret;
  }
   ...
   * @return the current {@link io.vertx.rxjava.servicediscovery.DiscoveryService}
   */
  public DiscoveryService registerDiscoveryBridge(DiscoveryBridge bridge, JsonObject configuration) { 
    DiscoveryService ret = DiscoveryService.newInstance(delegate.registerDiscoveryBridge((io.vertx.servicediscovery.spi.DiscoveryBridge)bridge.getDelegate(), configuration));
    return ret;
  }
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.rxjava.servicediscovery.DiscoveryService#getRecord}, this method may accept records with a <code>OUT OF SERVICE</code>
  ...
  /**
   * Lookups for a set of records. Unlike {@link io.vertx.rxjava.servicediscovery.DiscoveryService#getRecord}, this method returns all matching
   * records.
   * @param filter the filter - see {@link io.vertx.rxjava.servicediscovery.DiscoveryService#getRecord}
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.rxjava.servicediscovery.DiscoveryService#getRecords}, this method may accept records with a <code>OUT OF SERVICE</code>
   * status, if the <code>includeOutOfService</code> parameter is set to <code>true</code>.
   * @param filter the filter, must not be <code>null</code>. To return all records, use a function accepting all records
   * @param includeOutOfService whether or not the filter accepts <code>OUT OF SERVICE</code> records
   * @param resultHandler handler called when the lookup has been completed. When there are no matching record, the operation succeed, but the async result has an empty list as result.
  ...
  public static void releaseServiceObject(DiscoveryService discovery, Object svcObject) { 
    io.vertx.servicediscovery.DiscoveryService.releaseServiceObject((io.vertx.servicediscovery.DiscoveryService)discovery.getDelegate(), svcObject);
  }


  public static DiscoveryService newInstance(io.vertx.servicediscovery.DiscoveryService arg) {
