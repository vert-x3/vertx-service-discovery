...
public class EventBusService {
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, JsonObject filter, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.servicediscovery.types.EventBusService.getProxy((io.vertx.servicediscovery.ServiceDiscovery)discovery.getDelegate(), filter, resultHandler);
  }
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String serviceInterface, String proxyInterface, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.servicediscovery.types.EventBusService.getProxy((io.vertx.servicediscovery.ServiceDiscovery)discovery.getDelegate(), serviceInterface, proxyInterface, resultHandler);
  }
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, JsonObject filter, String proxyClass, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.servicediscovery.types.EventBusService.getProxy((io.vertx.servicediscovery.ServiceDiscovery)discovery.getDelegate(), filter, proxyClass, resultHandler);
  }
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String itf, Handler<AsyncResult<T>> resultHandler) { 
    io.vertx.servicediscovery.types.EventBusService.getProxy((io.vertx.servicediscovery.ServiceDiscovery)discovery.getDelegate(), itf, resultHandler);
  }
