...
public class HttpEndpoint {
  ...
  public static void getClient(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<HttpClient>> resultHandler) { 
    io.vertx.servicediscovery.types.HttpEndpoint.getClient((io.vertx.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
