...
public class MessageSource {
  ...
  public static <T> void getConsumer(DiscoveryService discovery, JsonObject filter, Handler<AsyncResult<MessageConsumer<T>>> resultHandler) { 
    io.vertx.servicediscovery.types.MessageSource.getConsumer((io.vertx.servicediscovery.DiscoveryService)discovery.getDelegate(), filter, new Handler<AsyncResult<io.vertx.core.eventbus.MessageConsumer<T>>>() {
