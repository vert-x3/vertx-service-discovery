...
public class DiscoveryBridge {
  ...
  public void start(Vertx vertx, ServiceDiscovery discovery, Map<String, Object> configuration, Future<Void> future) {
    delegate.start(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, configuration != null ? new io.vertx.core.json.JsonObject(configuration) : null, future != null ? (io.vertx.core.Future<java.lang.Void>)future.getDelegate() : null);
  }
  /**
   * Stops the bridge.
   * @param vertx the vertx instance
  ...
  public void stop(Vertx vertx, ServiceDiscovery discovery, Future<Void> future) {
    delegate.stop(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, future != null ? (io.vertx.core.Future<java.lang.Void>)future.getDelegate() : null);
  }
}
