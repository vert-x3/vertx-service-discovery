...
public class EventBusService {
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, Map<String, Object> filter, Handler<AsyncResult<T>> resultHandler) {
    io.vertx.ext.discovery.types.EventBusService.getProxy(discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<java.lang.Object>>() {
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String serviceInterface, String proxyInterface, Handler<AsyncResult<T>> resultHandler) {
    io.vertx.ext.discovery.types.EventBusService.getProxy(discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, serviceInterface, proxyInterface, resultHandler != null ? new Handler<AsyncResult<java.lang.Object>>() {
      public void handle(AsyncResult<java.lang.Object> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Object) InternalHelper.wrapObject(ar.result())));
        } else {
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, Map<String, Object> filter, String proxyClass, Handler<AsyncResult<T>> resultHandler) {
    io.vertx.ext.discovery.types.EventBusService.getProxy(discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, proxyClass, resultHandler != null ? new Handler<AsyncResult<java.lang.Object>>() {
      public void handle(AsyncResult<java.lang.Object> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Object) InternalHelper.wrapObject(ar.result())));
        } else {
  ...
  public static <T> void getProxy(ServiceDiscovery discovery, String itf, Handler<AsyncResult<T>> resultHandler) {
    io.vertx.ext.discovery.types.EventBusService.getProxy(discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, itf, resultHandler != null ? new Handler<AsyncResult<java.lang.Object>>() {
      public void handle(AsyncResult<java.lang.Object> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Object) InternalHelper.wrapObject(ar.result())));
        } else {
