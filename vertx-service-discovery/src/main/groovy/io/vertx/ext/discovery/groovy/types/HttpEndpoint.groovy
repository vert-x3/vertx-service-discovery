...
public class HttpEndpoint {
  ...
  public static void getClient(ServiceDiscovery discovery, Map<String, Object> filter, Handler<AsyncResult<HttpClient>> resultHandler) {
    io.vertx.ext.discovery.types.HttpEndpoint.getClient(discovery != null ? (io.vertx.ext.discovery.ServiceDiscovery)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
