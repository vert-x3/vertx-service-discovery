...
package io.vertx.groovy.ext.servicediscovery;
import groovy.transform.CompileStatic
import io.vertx.lang.groovy.InternalHelper
import io.vertx.core.json.JsonObject
import io.vertx.groovy.ext.servicediscovery.spi.DiscoveryBridge
 ...
 * <p>
 * * lookup for services
 * * bind to a selected service (it gets a {@link io.vertx.groovy.ext.servicediscovery.ServiceReference}) and use it
 * * release the service once the consumer is done with it
 * * listen for arrival, departure and modification of services.
 * <p>
 * Consumer would 1) lookup for service record matching their need, 2) retrieve the {@link io.vertx.groovy.ext.servicediscovery.ServiceReference} that give access
 ...
 * <p>
 * Providers and consumers must create their own {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService} instance. These instances are collaborating
 * in background (distributed structure) to keep the set of services in sync.
*/
@CompileStatic
public class DiscoveryService {
  private final def io.vertx.ext.servicediscovery.DiscoveryService delegate;
  public DiscoveryService(Object delegate) {
    this.delegate = (io.vertx.ext.servicediscovery.DiscoveryService) delegate;
  }
  public Object getDelegate() {
    return delegate;
  }
  /**
   * Creates an instance of {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService}.
  ...
  public static DiscoveryService create(Vertx vertx, Map<String, Object> options) {
    def ret = InternalHelper.safeCreate(io.vertx.ext.servicediscovery.DiscoveryService.create(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, options != null ? new io.vertx.ext.servicediscovery.DiscoveryOptions(new io.vertx.core.json.JsonObject(options)) : null), io.vertx.groovy.ext.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
   * Creates a new instance of {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService} using the default configuration.
   * @param vertx the vert.x instance
   * @return the created instance
   */
  public static DiscoveryService create(Vertx vertx) {
    def ret = InternalHelper.safeCreate(io.vertx.ext.servicediscovery.DiscoveryService.create(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null), io.vertx.groovy.ext.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
  ...
  public ServiceReference getReference(Map<String, Object> record = [:]) {
    def ret = InternalHelper.safeCreate(delegate.getReference(record != null ? new io.vertx.ext.servicediscovery.Record(new io.vertx.core.json.JsonObject(record)) : null), io.vertx.groovy.ext.servicediscovery.ServiceReference.class);
    return ret;
  }
  /**
  ...
  public ServiceReference getReferenceWithConfiguration(Map<String, Object> record = [:], Map<String, Object> configuration) {
    def ret = InternalHelper.safeCreate(delegate.getReferenceWithConfiguration(record != null ? new io.vertx.ext.servicediscovery.Record(new io.vertx.core.json.JsonObject(record)) : null, configuration != null ? new io.vertx.core.json.JsonObject(configuration) : null), io.vertx.groovy.ext.servicediscovery.ServiceReference.class);
    return ret;
  }
  /**
  ...
  public boolean release(ServiceReference reference) {
    def ret = delegate.release(reference != null ? (io.vertx.ext.servicediscovery.ServiceReference)reference.getDelegate() : null);
    return ret;
  }
  /**
   ...
   * @return the current {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService}
   */
  public DiscoveryService registerDiscoveryBridge(DiscoveryBridge bridge, Map<String, Object> configuration) {
    def ret = InternalHelper.safeCreate(delegate.registerDiscoveryBridge(bridge != null ? (io.vertx.ext.servicediscovery.spi.DiscoveryBridge)bridge.getDelegate() : null, configuration != null ? new io.vertx.core.json.JsonObject(configuration) : null), io.vertx.groovy.ext.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
  ...
  public void publish(Map<String, Object> record = [:], Handler<AsyncResult<Map<String, Object>>> resultHandler) {
    delegate.publish(record != null ? new io.vertx.ext.servicediscovery.Record(new io.vertx.core.json.JsonObject(record)) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.ext.servicediscovery.Record>>() {
      public void handle(AsyncResult<io.vertx.ext.servicediscovery.Record> ar) {
        if (ar.succeeded()) {
  ...
  public void getRecord(Map<String, Object> filter, Handler<AsyncResult<Map<String, Object>>> resultHandler) {
    delegate.getRecord(filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.ext.servicediscovery.Record>>() {
      public void handle(AsyncResult<io.vertx.ext.servicediscovery.Record> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Map<String, Object>)InternalHelper.wrapObject(ar.result()?.toJson())));
        } else {
  ...
  public void getRecord(java.util.function.Function<Map<String, Object>, Boolean> filter, Handler<AsyncResult<Map<String, Object>>> resultHandler) {
    delegate.getRecord(filter != null ? new java.util.function.Function<io.vertx.ext.servicediscovery.Record, java.lang.Boolean>(){
      public java.lang.Boolean apply(io.vertx.ext.servicediscovery.Record arg_) {
        def ret = filter.apply((Map<String, Object>)InternalHelper.wrapObject(arg_?.toJson()));
        return ret != null ? ret : null;
      }
    } : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.ext.servicediscovery.Record>>() {
      public void handle(AsyncResult<io.vertx.ext.servicediscovery.Record> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Map<String, Object>)InternalHelper.wrapObject(ar.result()?.toJson())));
        } else {
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService#getRecord}, this method may accept records with a <code>OUT OF SERVICE</code>
  ...
  public void getRecord(java.util.function.Function<Map<String, Object>, Boolean> filter, boolean includeOutOfService, Handler<AsyncResult<Map<String, Object>>> resultHandler) {
    ...
    } : null, includeOutOfService, resultHandler != null ? new Handler<AsyncResult<io.vertx.ext.servicediscovery.Record>>() {
      public void handle(AsyncResult<io.vertx.ext.servicediscovery.Record> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Map<String, Object>)InternalHelper.wrapObject(ar.result()?.toJson())));
        } else {
  ...
  /**
   * Lookups for a set of records. Unlike {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService#getRecord}, this method returns all matching
   * records.
   * @param filter the filter - see {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService#getRecord}
  ...
  public void getRecords(Map<String, Object> filter, Handler<AsyncResult<List<Map<String, Object>>>> resultHandler) {
    delegate.getRecords(filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>>>() {
      public void handle(AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>> ar) {
        if (ar.succeeded()) {
  ...
  public void getRecords(java.util.function.Function<Map<String, Object>, Boolean> filter, Handler<AsyncResult<List<Map<String, Object>>>> resultHandler) {
    delegate.getRecords(filter != null ? new java.util.function.Function<io.vertx.ext.servicediscovery.Record, java.lang.Boolean>(){
      public java.lang.Boolean apply(io.vertx.ext.servicediscovery.Record arg_) {
        def ret = filter.apply((Map<String, Object>)InternalHelper.wrapObject(arg_?.toJson()));
        return ret != null ? ret : null;
      }
    } : null, resultHandler != null ? new Handler<AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>>>() {
      public void handle(AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((List)ar.result()?.collect({(Map<String, Object>)InternalHelper.wrapObject(it?.toJson())})));
        } else {
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.groovy.ext.servicediscovery.DiscoveryService#getRecords}, this method may accept records with a <code>OUT OF SERVICE</code>
   * status, if the <code>includeOutOfService</code> parameter is set to <code>true</code>.
   * @param filter the filter, must not be <code>null</code>. To return all records, use a function accepting all records
   * @param includeOutOfService whether or not the filter accepts <code>OUT OF SERVICE</code> records
   * @param resultHandler handler called when the lookup has been completed. When there are no matching record, the operation succeed, but the async result has an empty list as result.
  ...
  public void getRecords(java.util.function.Function<Map<String, Object>, Boolean> filter, boolean includeOutOfService, Handler<AsyncResult<List<Map<String, Object>>>> resultHandler) {
    ...
    } : null, includeOutOfService, resultHandler != null ? new Handler<AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>>>() {
      public void handle(AsyncResult<java.util.List<io.vertx.ext.servicediscovery.Record>> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((List)ar.result()?.collect({(Map<String, Object>)InternalHelper.wrapObject(it?.toJson())})));
        } else {
  ...
  public void update(Map<String, Object> record = [:], Handler<AsyncResult<Map<String, Object>>> resultHandler) {
    delegate.update(record != null ? new io.vertx.ext.servicediscovery.Record(new io.vertx.core.json.JsonObject(record)) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.ext.servicediscovery.Record>>() {
      public void handle(AsyncResult<io.vertx.ext.servicediscovery.Record> ar) {
        if (ar.succeeded()) {
          resultHandler.handle(io.vertx.core.Future.succeededFuture((Map<String, Object>)InternalHelper.wrapObject(ar.result()?.toJson())));
        } else {
  ...
  public Set<ServiceReference> bindings() {
    def ret = (Set)delegate.bindings()?.collect({InternalHelper.safeCreate(it, io.vertx.groovy.ext.servicediscovery.ServiceReference.class)}) as Set;
    return ret;
  }
  /**
  ...
  public static void releaseServiceObject(DiscoveryService discovery, Object svcObject) {
    io.vertx.ext.servicediscovery.DiscoveryService.releaseServiceObject(discovery != null ? (io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate() : null, svcObject != null ? InternalHelper.unwrapObject(svcObject) : null);
  }
}
