...
public class HttpEndpoint {
  private final def io.vertx.ext.servicediscovery.types.HttpEndpoint delegate;
  public HttpEndpoint(Object delegate) {
    this.delegate = (io.vertx.ext.servicediscovery.types.HttpEndpoint) delegate;
  }
  ...
  public static Map<String, Object> createRecord(String name, String host, int port, String root, Map<String, Object> metadata) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.HttpEndpoint.createRecord(name, host, port, root, metadata != null ? new io.vertx.core.json.JsonObject(metadata) : null)?.toJson());
    return ret;
  }
  /**
   * Same as {@link io.vertx.groovy.ext.servicediscovery.types.HttpEndpoint#createRecord} but let you configure whether or not the
  ...
  public static Map<String, Object> createRecord(String name, boolean ssl, String host, int port, String root, Map<String, Object> metadata) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.HttpEndpoint.createRecord(name, ssl, host, port, root, metadata != null ? new io.vertx.core.json.JsonObject(metadata) : null)?.toJson());
    return ret;
  }
  /**
   * Same as {@link io.vertx.groovy.ext.servicediscovery.types.HttpEndpoint#createRecord} but without metadata.
   * @param name the service name
  ...
  public static Map<String, Object> createRecord(String name, String host, int port, String root) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.HttpEndpoint.createRecord(name, host, port, root)?.toJson());
    return ret;
  }
  /**
   * Same as {@link io.vertx.groovy.ext.servicediscovery.types.HttpEndpoint#createRecord} but without metadata, using the port 80
   * and using "/" as root.
   * @param name the name
   * @param host the host
   * @return the created record (see <a href="../../../../../../../../cheatsheet/Record.html">Record</a>)
  ...
  public static Map<String, Object> createRecord(String name, String host) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.HttpEndpoint.createRecord(name, host)?.toJson());
    return ret;
  }
  /**
   ...
   */
  public static void getClient(DiscoveryService discovery, Map<String, Object> filter, Handler<AsyncResult<HttpClient>> resultHandler) {
    io.vertx.ext.servicediscovery.types.HttpEndpoint.getClient(discovery != null ? (io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
