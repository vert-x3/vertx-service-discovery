...
public class MessageSource {
  private final def io.vertx.ext.servicediscovery.types.MessageSource delegate;
  public MessageSource(Object delegate) {
    this.delegate = (io.vertx.ext.servicediscovery.types.MessageSource) delegate;
  }
  ...
  public static Map<String, Object> createRecord(String name, String address, String type, Map<String, Object> metadata) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.MessageSource.createRecord(name, address, type, metadata != null ? new io.vertx.core.json.JsonObject(metadata) : null)?.toJson());
    return ret;
  }
  /**
   * Same as {@link io.vertx.groovy.ext.servicediscovery.types.MessageSource#createRecord} without additional metadata.
   * @param name the name of the service
   * @param address the address on which the data is sent
  ...
  public static Map<String, Object> createRecord(String name, String address, String type) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.MessageSource.createRecord(name, address, type)?.toJson());
    return ret;
  }
  /**
   * Same as {@link io.vertx.groovy.ext.servicediscovery.types.MessageSource#createRecord} without additional metadata, and no type for
   * the payload.
   * @param name the name of the service
   * @param address the address on which the data is sent.
   * @return the created record (see <a href="../../../../../../../../cheatsheet/Record.html">Record</a>)
  ...
  public static Map<String, Object> createRecord(String name, String address) {
    def ret = (Map<String, Object>)InternalHelper.wrapObject(io.vertx.ext.servicediscovery.types.MessageSource.createRecord(name, address)?.toJson());
    return ret;
  }
  /**
  ...
  public static <T> void getConsumer(DiscoveryService discovery, Map<String, Object> filter, Handler<AsyncResult<MessageConsumer<T>>> resultHandler) {
    io.vertx.ext.servicediscovery.types.MessageSource.getConsumer(discovery != null ? (io.vertx.ext.servicediscovery.DiscoveryService)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.core.eventbus.MessageConsumer<java.lang.Object>>>() {
