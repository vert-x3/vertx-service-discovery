...
import io.vertx.groovy.servicediscovery.spi.DiscoveryBridge
 ...
 * <p>
 * Providers and consumers must create their own {@link io.vertx.groovy.servicediscovery.DiscoveryService} instance. These instances are collaborating
 * in background (distributed structure) to keep the set of services in sync.
*/
@CompileStatic
public class DiscoveryService {
  private final def io.vertx.servicediscovery.DiscoveryService delegate;
  public DiscoveryService(Object delegate) {
    this.delegate = (io.vertx.servicediscovery.DiscoveryService) delegate;
  }
  public Object getDelegate() {
    return delegate;
  }
  /**
   * Creates an instance of {@link io.vertx.groovy.servicediscovery.DiscoveryService}.
  ...
  public static DiscoveryService create(Vertx vertx, Map<String, Object> options) {
    def ret = InternalHelper.safeCreate(io.vertx.servicediscovery.DiscoveryService.create(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null, options != null ? new io.vertx.servicediscovery.DiscoveryOptions(new io.vertx.core.json.JsonObject(options)) : null), io.vertx.groovy.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
   * Creates a new instance of {@link io.vertx.groovy.servicediscovery.DiscoveryService} using the default configuration.
   * @param vertx the vert.x instance
   * @return the created instance
   */
  public static DiscoveryService create(Vertx vertx) {
    def ret = InternalHelper.safeCreate(io.vertx.servicediscovery.DiscoveryService.create(vertx != null ? (io.vertx.core.Vertx)vertx.getDelegate() : null), io.vertx.groovy.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
   ...
   * @return the current {@link io.vertx.groovy.servicediscovery.DiscoveryService}
   */
  public DiscoveryService registerDiscoveryBridge(DiscoveryBridge bridge, Map<String, Object> configuration) {
    def ret = InternalHelper.safeCreate(delegate.registerDiscoveryBridge(bridge != null ? (io.vertx.servicediscovery.spi.DiscoveryBridge)bridge.getDelegate() : null, configuration != null ? new io.vertx.core.json.JsonObject(configuration) : null), io.vertx.groovy.servicediscovery.DiscoveryService.class);
    return ret;
  }
  /**
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.groovy.servicediscovery.DiscoveryService#getRecord}, this method may accept records with a <code>OUT OF SERVICE</code>
  ...
  /**
   * Lookups for a set of records. Unlike {@link io.vertx.groovy.servicediscovery.DiscoveryService#getRecord}, this method returns all matching
   * records.
   * @param filter the filter - see {@link io.vertx.groovy.servicediscovery.DiscoveryService#getRecord}
   ...
   * as an <code>accept</code> method of a filter. This method return a record passing the filter.
   * <p>
   * Unlike {@link io.vertx.groovy.servicediscovery.DiscoveryService#getRecords}, this method may accept records with a <code>OUT OF SERVICE</code>
   * status, if the <code>includeOutOfService</code> parameter is set to <code>true</code>.
   * @param filter the filter, must not be <code>null</code>. To return all records, use a function accepting all records
   * @param includeOutOfService whether or not the filter accepts <code>OUT OF SERVICE</code> records
   * @param resultHandler handler called when the lookup has been completed. When there are no matching record, the operation succeed, but the async result has an empty list as result.
  ...
  public static void releaseServiceObject(DiscoveryService discovery, Object svcObject) {
    io.vertx.servicediscovery.DiscoveryService.releaseServiceObject(discovery != null ? (io.vertx.servicediscovery.DiscoveryService)discovery.getDelegate() : null, svcObject != null ? InternalHelper.unwrapObject(svcObject) : null);
  }
}
