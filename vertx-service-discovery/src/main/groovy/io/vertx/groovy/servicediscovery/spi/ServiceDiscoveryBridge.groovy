...
public class ServiceDiscoveryBridge {
  private final def io.vertx.servicediscovery.spi.ServiceDiscoveryBridge delegate;
  public ServiceDiscoveryBridge(Object delegate) {
    this.delegate = (io.vertx.servicediscovery.spi.ServiceDiscoveryBridge) delegate;
  }
