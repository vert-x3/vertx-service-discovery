...
public class HttpEndpoint {
  ...
  public static void getClient(DiscoveryService discovery, Map<String, Object> filter, Handler<AsyncResult<HttpClient>> resultHandler) {
    io.vertx.servicediscovery.types.HttpEndpoint.getClient(discovery != null ? (io.vertx.servicediscovery.DiscoveryService)discovery.getDelegate() : null, filter != null ? new io.vertx.core.json.JsonObject(filter) : null, resultHandler != null ? new Handler<AsyncResult<io.vertx.core.http.HttpClient>>() {
