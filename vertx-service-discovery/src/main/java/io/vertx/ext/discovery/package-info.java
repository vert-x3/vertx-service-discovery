 ...
 * {@link io.vertx.ext.discovery.Record}.
 * 
 ...
 * 
 * Providers and consumers must create their own {@link io.vertx.ext.discovery.ServiceDiscovery} instance. These
 ...
 * {@link io.vertx.ext.discovery.ServiceDiscovery#getReference(io.vertx.ext.discovery.Record)} or released with
 ...
 * 
 * Publishers and consumers must create their own {@link io.vertx.ext.discovery.ServiceDiscovery}
 ...
 * {@link io.vertx.ext.discovery.ServiceDiscovery#getRecords(io.vertx.core.json.JsonObject, io.vertx.core.Handler)}.
 ...
 * {@link io.vertx.ext.discovery.ServiceDiscovery#getRecords(java.util.function.Function, boolean, io.vertx.core.Handler)}
 * .
 * 
 ...
 * [source,$lang]
 * ----
 * {@link examples.Examples#example5(io.vertx.ext.discovery.ServiceDiscovery, io.vertx.ext.discovery.Record)}
 * ----
 * 
 ...
 * [source,$lang]
 * ----
 * {@link examples.Examples#example51(io.vertx.ext.discovery.ServiceDiscovery, io.vertx.ext.discovery.Record, io.vertx.core.json.JsonObject)}
 * ----
 * 
 * == Types of services
 * 
 ...
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example2(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 * You can also use the
 * {@link io.vertx.ext.discovery.types.HttpEndpoint#getClient(io.vertx.ext.discovery.ServiceDiscovery, io.vertx.core.json.JsonObject, io.vertx.core.Handler)}
 * method to combine lookup and service retrieval in one call:
 *
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example3(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 * In this second version, the service object is released using
 * {@link io.vertx.ext.discovery.ServiceDiscovery#releaseServiceObject(io.vertx.ext.discovery.ServiceDiscovery, java.lang.Object)},
 ...
 * [source, $lang]
 * ----
 * {@link examples.EventBusServiceExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 * [language, java]
 * ----
 ...
 * [source, java]
 * \----
 * {@link examples.limited.EventBusServiceJavaExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * \----
 * ----
 *
 ...
 * [source, java]
 * \----
 * {@link examples.EventBusServiceExamples#example2(io.vertx.ext.discovery.ServiceDiscovery)}
 * \----
 *
 * With the {@link io.vertx.ext.discovery.types.EventBusService} class, you can get the proxy as follows:
 * [source, java]
 * \----
 * {@link examples.EventBusServiceExamples#example3(io.vertx.ext.discovery.ServiceDiscovery)}
 * \----
 * ----
 * [language, groovy]
 * ----
 ...
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 ...
 * [source, $lang]
 * \----
 * {@link examples.limited.MessageSourceExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * \----
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example2(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example3(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 * === JDBC Data source
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example1(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example2(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example3(io.vertx.ext.discovery.ServiceDiscovery)}
 * ----
 * 
 ...
 * This address is configurable from the {@link io.vertx.ext.discovery.ServiceDiscoveryOptions}.
 * 
 ...
 * .discovery.usage` address. This address is configurable from the {@link io.vertx.ext.discovery.ServiceDiscoveryOptions}.
 *
 ...
 *
 * This `id` is configurable from the {@link io.vertx.ext.discovery.ServiceDiscoveryOptions}. By default it's "localhost" on
 ...
 * {@link io.vertx.ext.discovery.ServiceDiscoveryOptions#setUsageAddress(java.lang.String)}.
 *
 * 
 ...
 * register it using
 * {@link io.vertx.ext.discovery.ServiceDiscovery#registerDiscoveryBridge(DiscoveryBridge, io.vertx.core.json.JsonObject)}.
 *
