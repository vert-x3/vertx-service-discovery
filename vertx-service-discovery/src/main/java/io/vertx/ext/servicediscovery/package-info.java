 ...
 * described by a {@link io.vertx.ext.servicediscovery.Record}.
 * 
 ...
 * 
 * * lookup for services
 * * bind to a selected service (it gets a {@link io.vertx.ext.servicediscovery.ServiceReference}) and use it
 * * release the service once the consumer is done with it
 * * listen for arrival, departure and modification of services.
 * 
 * Consumer would 1) lookup for service record matching their need, 2) retrieve the
 * {@link io.vertx.ext.servicediscovery.ServiceReference} that give access to the service, 3) get a service object to access
 ...
 * {@link io.vertx.ext.servicediscovery.Record records}.
 * 
 * Providers and consumers must create their own {@link io.vertx.ext.servicediscovery.DiscoveryService} instance. These
 ...
 * === Service records
 * 
 * A service {@link io.vertx.ext.servicediscovery.Record} is an object that describes a service published by a service
 ...
 * {@link io.vertx.ext.servicediscovery.Record}. From these records, a consumer can retrieve a
 * {@link io.vertx.ext.servicediscovery.ServiceReference}, representing the binding between the consumer and the provider.
 ...
 * {@link io.vertx.ext.servicediscovery.DiscoveryService#getReference(Record)} or released with
 * {@link io.vertx.ext.servicediscovery.ServiceReference#release()}, events are emitted on the event bus to track the
 * service usages.
 *
 ...
 * {@link io.vertx.ext.servicediscovery.spi.DiscoveryBackend} SPI.
 *
 * Notice that the discovery does not required vert.x clustering. In single-node mode, the map is a local map. It can
 * be populated with {@link io.vertx.ext.servicediscovery.spi.DiscoveryBridge}s.
 * 
 * == Creating the discovery service
 * 
 * Publishers and consumers must create their own {@link io.vertx.ext.servicediscovery.DiscoveryService}
 ...
 * 
 * To create records, you can either use the {@link io.vertx.ext.servicediscovery.Record} class, or use convenient methods
 ...
 *
 * 1. A function taking a {@link io.vertx.ext.servicediscovery.Record} as parameter and returning a boolean
 ...
 * {@link io.vertx.ext.servicediscovery.DiscoveryService#getRecords(io.vertx.core.json.JsonObject, io.vertx.core.Handler)}.
 ...
 * {@link io.vertx.ext.servicediscovery.DiscoveryService#getRecords(java.util.function.Function, boolean, io.vertx.core.Handler)}
 * .
 * 
 * == Retrieving a service reference
 * 
 * Once you have chosen the {@link io.vertx.ext.servicediscovery.Record}, you can retrieve a
 * {@link io.vertx.ext.servicediscovery.ServiceReference} and then the service object:
 * 
 * [source,$lang]
 * ----
 * {@link examples.Examples#example5(DiscoveryService, Record)}
 * ----
 * 
 ...
 * [source,$lang]
 * ----
 * {@link examples.Examples#example51(DiscoveryService, Record, io.vertx.core.json.JsonObject)}
 * ----
 * 
 * == Types of services
 * 
 ...
 * 
 * * {@link io.vertx.ext.servicediscovery.types.HttpEndpoint} - for REST API, the service object is a
 * {@link io.vertx.core.http.HttpClient} configured on the host and port (the location is the url).
 * * {@link io.vertx.ext.servicediscovery.types.EventBusService} - for service proxies, the service object is a proxy. Its
 * type is the proxies interface (the location is the address).
 * * {@link io.vertx.ext.servicediscovery.types.MessageSource} - for message source (publisher), the service object is a
 * {@link io.vertx.core.eventbus.MessageConsumer} (the location is the address).
 * * {@link io.vertx.ext.servicediscovery.types.JDBCDataSource} - for JDBC data sources, the service object is a
 ...
 *
 * Some records may have no type ({@link io.vertx.ext.servicediscovery.spi.ServiceType#UNKNOWN}). It is not possible to
 * retrieve a reference for these records, but you can build the connection details from the `location` and
 * `metadata` of the {@link io.vertx.ext.servicediscovery.Record}.
 *
 ...
 * 
 * You can create your own service type by implementing the {@link io.vertx.ext.servicediscovery.spi.ServiceType} SPI:
 *
 * 1. (optional) Create a public interface extending {@link io.vertx.ext.servicediscovery.spi.ServiceType}. This interface is
 * only used to provide helper methods to ease the usage of your type such as `createRecord` methods, `getX` where `X`
 * is the type of service object you retrieve and so on. Check {@link io.vertx.ext.servicediscovery.types.HttpEndpoint} or
 * {@link io.vertx.ext.servicediscovery.types.MessageSource} for examples
 * 2. Create a class implementing {@link io.vertx.ext.servicediscovery.spi.ServiceType} or the interface you created in the
 * step 1. The type has a `name`, and a method to create the {@link io.vertx.ext.servicediscovery.ServiceReference} for this
 * type. The name must match the `type` field of the {@link io.vertx.ext.servicediscovery.Record} associated with your type.
 ...
 *
 * To publish a HTTP endpoint, you need a {@link io.vertx.ext.servicediscovery.Record}. You can create the record using
 * {@link io.vertx.ext.servicediscovery.types.HttpEndpoint#createRecord(java.lang.String, java.lang.String, int, java.lang.String, io.vertx.core.json.JsonObject)}.
 *
 * The next snippet illustrates hot to create {@link io.vertx.ext.servicediscovery.Record} from
 * {@link io.vertx.ext.servicediscovery.types.HttpEndpoint}:
 *
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example1(DiscoveryService)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example2(DiscoveryService)}
 * ----
 *
 * You can also use the
 * {@link io.vertx.ext.servicediscovery.types.HttpEndpoint#getClient(DiscoveryService, io.vertx.core.json.JsonObject, io.vertx.core.Handler)}
 * method to combine lookup and service retrieval in one call:
 *
 * [source, $lang]
 * ----
 * {@link examples.HTTPEndpointExamples#example3(DiscoveryService)}
 * ----
 *
 * In this second version, the service object is released using
 * {@link io.vertx.ext.servicediscovery.DiscoveryService#releaseServiceObject(DiscoveryService, java.lang.Object)},
 ...
 * methods from {@link io.vertx.ext.servicediscovery.types.EventBusService}.
 *
 ...
 *
 * To publish an event bus service, you need to create a {@link io.vertx.ext.servicediscovery.Record}:
 *
 * [source, $lang]
 * ----
 * {@link examples.EventBusServiceExamples#example1(DiscoveryService)}
 * ----
 *
 * [language, java]
 * ----
 ...
 * [source, java]
 * \----
 * {@link examples.limited.EventBusServiceJavaExamples#example1(DiscoveryService)}
 * \----
 * ----
 *
 ...
 * {@link io.vertx.ext.servicediscovery.types.EventBusService} interface that combine the two operations in one call.
 *
 * When using the reference, you would do somehting like:
 * [source, java]
 * \----
 * {@link examples.EventBusServiceExamples#example2(DiscoveryService)}
 * \----
 *
 * With the {@link io.vertx.ext.servicediscovery.types.EventBusService} class, you can get the proxy as follows:
 * [source, java]
 * \----
 * {@link examples.EventBusServiceExamples#example3(DiscoveryService)}
 * \----
 * ----
 * [language, groovy]
 * ----
 * To consume an event bus service you can either retrieve the record and then get the reference, or use the
 * {@link io.vertx.ext.servicediscovery.types.EventBusService} interface that combines the two operations in one call.
 *
 ...
 *
 * 1. create a record, using {@link io.vertx.ext.servicediscovery.types.MessageSource}
 * 2. publish the record
 *
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example1(DiscoveryService)}
 * ----
 *
 ...
 * [source, $lang]
 * \----
 * {@link examples.limited.MessageSourceExamples#example1(DiscoveryService)}
 * \----
 * ----
 *
 ...
 * {@link io.vertx.ext.servicediscovery.types.MessageSource} class to retrieve the service is one call.
 *
 * With the first approach, the code is the following:
 *
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example2(DiscoveryService)}
 * ----
 *
 * When, using {@link io.vertx.ext.servicediscovery.types.MessageSource}, it becomes:
 *
 * [source, $lang]
 * ----
 * {@link examples.MessageSourceExamples#example3(DiscoveryService)}
 * ----
 *
 * === JDBC Data source
 *
 ...
 * As for the other service types, publishing a message source is a 2-steps process:
 *
 * 1. create a record, using {@link io.vertx.ext.servicediscovery.types.JDBCDataSource}
 * 2. publish the record
 *
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example1(DiscoveryService)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example2(DiscoveryService)}
 * ----
 *
 ...
 * [source, $lang]
 * ----
 * {@link examples.JDBCDataSourceExamples#example3(DiscoveryService)}
 * ----
 * 
 ...
 * This address is configurable from the {@link io.vertx.ext.servicediscovery.DiscoveryOptions}.
 * 
 ...
 * .discovery.usage` address. This address is configurable from the {@link io.vertx.ext.servicediscovery.DiscoveryOptions}.
 *
 ...
 *
 * This `id` is configurable from the {@link io.vertx.ext.servicediscovery.DiscoveryOptions}. By default it's "localhost" on
 ...
 * {@link io.vertx.ext.servicediscovery.DiscoveryOptions#setUsageAddress(java.lang.String)}.
 *
 * 
 ...
 * 
 * You can provide your own bridge by implementing the {@link io.vertx.ext.servicediscovery.spi.DiscoveryBridge} interface and
 * register it using
 * {@link io.vertx.ext.servicediscovery.DiscoveryService#registerDiscoveryBridge(DiscoveryBridge, io.vertx.core.json.JsonObject)}.
 *
 * The second parameter can provide an optional configuration for the bridge.
 *
 * When the bridge is registered the
 *
 * {@link io.vertx.ext.servicediscovery.spi.DiscoveryBridge#start)}
 ...
 * {@link io.vertx.ext.servicediscovery.spi.DiscoveryBridge#stop}
