 ...
 * 
 * Providers and consumers must create their own {@link io.vertx.servicediscovery.DiscoveryService} instance. These
 ...
 * {@link io.vertx.servicediscovery.DiscoveryService#getReference(Record)} or released with
 ...
 * {@link io.vertx.servicediscovery.spi.DiscoveryBackend} SPI.
 *
 * Notice that the discovery does not required vert.x clustering. In single-node mode, the map is a local map. It can
 * be populated with {@link io.vertx.servicediscovery.spi.DiscoveryBridge}s.
 * 
 * == Creating the discovery service
 * 
 * Publishers and consumers must create their own {@link io.vertx.servicediscovery.DiscoveryService}
 ...
 * {@link io.vertx.servicediscovery.DiscoveryService#getRecords(io.vertx.core.json.JsonObject, io.vertx.core.Handler)}.
 ...
 * {@link io.vertx.servicediscovery.DiscoveryService#getRecords(java.util.function.Function, boolean, io.vertx.core.Handler)}
 * .
 * 
 ...
 * {@link io.vertx.servicediscovery.types.HttpEndpoint#getClient(DiscoveryService, io.vertx.core.json.JsonObject, io.vertx.core.Handler)}
 ...
 * {@link io.vertx.servicediscovery.DiscoveryService#releaseServiceObject(DiscoveryService, java.lang.Object)},
 ...
 * This address is configurable from the {@link io.vertx.servicediscovery.DiscoveryOptions}.
 * 
 ...
 * .discovery.usage` address. This address is configurable from the {@link io.vertx.servicediscovery.DiscoveryOptions}.
 *
 ...
 *
 * This `id` is configurable from the {@link io.vertx.servicediscovery.DiscoveryOptions}. By default it's "localhost" on
 ...
 * {@link io.vertx.servicediscovery.DiscoveryOptions#setUsageAddress(java.lang.String)}.
 *
 * 
 ...
 * 
 * You can provide your own bridge by implementing the {@link io.vertx.servicediscovery.spi.DiscoveryBridge} interface and
 * register it using
 * {@link io.vertx.servicediscovery.DiscoveryService#registerDiscoveryBridge(DiscoveryBridge, io.vertx.core.json.JsonObject)}.
 *
 ...
 * {@link io.vertx.servicediscovery.spi.DiscoveryBridge#stop}
