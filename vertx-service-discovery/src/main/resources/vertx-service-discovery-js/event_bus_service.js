...
EventBusService.getProxy = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
    JEventBusService["getProxy(io.vertx.ext.discovery.ServiceDiscovery,io.vertx.core.json.JsonObject,io.vertx.core.Handler)"](__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
    if (ar.succeeded()) {
    ...
    JEventBusService["getProxy(io.vertx.ext.discovery.ServiceDiscovery,java.lang.String,io.vertx.core.Handler)"](__args[0]._jdel, __args[1], function(ar) {
    if (ar.succeeded()) {
      __args[2](utils.convReturnTypeUnknown(ar.result()), null);
    } else {
      __args[2](null, ar.cause());
    ...
    JEventBusService["getProxy(io.vertx.ext.discovery.ServiceDiscovery,java.lang.String,java.lang.String,io.vertx.core.Handler)"](__args[0]._jdel, __args[1], __args[2], function(ar) {
    if (ar.succeeded()) {
    ...
    JEventBusService["getProxy(io.vertx.ext.discovery.ServiceDiscovery,io.vertx.core.json.JsonObject,java.lang.String,io.vertx.core.Handler)"](__args[0]._jdel, utils.convParamJsonObject(__args[1]), __args[2], function(ar) {
    if (ar.succeeded()) {
      __args[3](utils.convReturnTypeUnknown(ar.result()), null);
    } else {
      __args[3](null, ar.cause());
